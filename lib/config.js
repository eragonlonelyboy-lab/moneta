...
const DEFAULTS = {
  ...
  output_warn_tokens: 8000,        // post-hoc nudge when a shell/webfetch/mcp/agent result exceeds this
  budget_thresholds: [60, 80],     // context-% checkpoints: offload at the first, wrap+compact at the second
...
function appendJSONL(p, obj) {
  ...
  const workId = obj.work_id || process.env.MONETA_WORK_ID || null;
  fs.appendFileSync(p, JSON.stringify(workId ? { ...obj, work_id: workId } : obj) + '\n', 'utf8');
}
