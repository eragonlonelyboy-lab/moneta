...
function doctrineText(cfg) {
  ...
  return [
    ...
    '10. **Honest numbers.** Never claim token savings you did not measure. In this workspace only the MONETA runtime ledger counts; an agent following these rules without hooks is governed but unmeasured.'
  ].join('\n');
}
